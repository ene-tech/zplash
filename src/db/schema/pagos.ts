...
export const suscripcionesOneclick = pgTable("suscripciones_oneclick", {
  ...
  // pendiente|pendiente_solo_tarjeta|activa|pausada_validacion_x5|suspendida|
  // cancelada — la variante "_solo_tarjeta" es igual a "pendiente" salvo que
  // le dice a /inscripcion/retorno que no cobre de inmediato al confirmar
  // (inscripción disparada desde "Mis tarjetas", no desde /pagar). La
  // "pausada_validacion_x5" la pone cobrarSuscripcion() y la levanta el cron
